...
mov dh, cs:poprzedni_znak ; wczytanie poprzedniego znaku
mov dl, cs:poprzedni_kolor ; wczytanie poprzedniego koloru

mov byte PTR es:[bx-2],dh ; usunięcie poprzedniego znaku
mov byte PTR es:[bx-1],dl ; usunięcie poprzedniego koloru

mov dh, es:[bx] ; zapisanie kodu ASCII w rejestrze DH
mov dl, es:[bx+1] ; zapisanie koloru w rejestrze DL
...
mov byte PTR es:[bx+1], 0Fh ; kolor
mov byte PTR cs:poprzedni_znak, dh ; zapisanie kodu ASCII
mov byte PTR cs:poprzedni_kolor, dl ; zapisanie koloru
; zwiększenie o 2 adresu bieżącego w pamięci ekranu
add bx,2
; sprawdzenie czy adres bieżący osiągnął koniec pamięci ekranu
cmp bx,4000
jb wysw_dalej1 ; skok gdy nie koniec ekranu
; wyzerowanie adresu bieżącego, gdy cały ekran zapisany
mov bx, 0
;zapisanie adresu bieżącego do zmiennej 'licznik'
wysw_dalej1:
...
poprzedni_znak db 0 ; poprzedni znak
poprzedni_kolor db 0 ; poprzedni kolor
wektor8 dd ?
ret
obsluga_zegara ENDP
;============================================================
